  ...
  return (
    <div className="relative">
      <button 
        type="button"
        onClick={onToggle}
        className="flex items-center gap-1.5 px-3 py-1.5 bg-white border border-gray-200 rounded-full text-xs font-medium text-gray-600 hover:bg-gray-50 transition-colors shadow-sm"
      >
        <Sparkles size={12} />
                  ...
                  <div className="flex flex-wrap gap-2 justify-center">
                    {SUGGESTIONS.map((suggestion) => (
                      <button
                        ...
                        className="px-4 py-2 bg-white/60 hover:bg-white border border-gray-200/50 hover:border-gray-300 rounded-full text-sm text-gray-600 hover:text-gray-900 transition-all shadow-sm hover:shadow-md backdrop-blur-sm"
                      >
                        {suggestion} ›
                      </button>
                    ))}
