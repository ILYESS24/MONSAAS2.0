...
// ⚠️ SÉCURITÉ: OpenRouter API key est maintenant UNIQUEMENT côté backend
// ============================================
...
export const env = {
  ...
  // Stripe - Paiements (optionnel pour mode démo)
  ...
  // ✅ SÉCURITÉ: OpenRouter API key supprimée du frontend
  // L'IA est maintenant gérée via /api/ai-chat backend
  // OPENROUTER_API_KEY est dans Cloudflare env (backend)

  // Freepik - Images IA (backend only)
  // FREEPIK_API_KEY est dans Cloudflare env (backend)
};
