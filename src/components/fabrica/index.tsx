...
const FooterSection = () => {
  return (
    <section className="relative bg-[#f5f5f5] py-20 px-6 md:px-12">
      {/* Geometric grid */}
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="flex flex-col md:flex-row items-start md:items-end justify-between gap-8">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="font-display font-bold text-4xl md:text-5xl text-black mb-4">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="flex flex-wrap gap-6 text-sm font-body text-black/50"
          >
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="mt-16 pt-8 border-t border-black/10 flex flex-col md:flex-row items-center justify-between gap-4"
        >
