...
export const planService = {
  ...
  async getCurrentPlan(): Promise<UserPlan | null> {
    ...
    if (data) {
      ...
      // Ces propriétés seraient calculées depuis les crédits et logs d'usage
      data.creditsUsedThisPeriod = 0; // TODO: calculer depuis les logs
      data.monthlyUsage = {}; // TODO: calculer depuis les logs
    }
