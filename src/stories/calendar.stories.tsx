...
// Wrapper component for DatePickerRange to use hooks properly
...
// Wrapper component for DatePickerWithPresets to use hooks properly
function DatePickerWithPresetsWrapper() {
...
export const DatePickerWithPresets = {
  render: () => <DatePickerWithPresetsWrapper />,
  args: {},
};
